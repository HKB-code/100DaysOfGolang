...
Instead of manually listing all numbers and strings, the standard cmp package provides cmp.Ordered, which includes all types that support <, <=, >, >=
*/
